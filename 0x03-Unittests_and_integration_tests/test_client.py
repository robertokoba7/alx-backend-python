...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org, expected, get_patch):
        """
        Test that the client's org can be fetched
        """
    ...
    def test_public_repos(self, get_json_mock):
        """
        Test that public repos can be fetched from the Github API
        """
    ...
    def test_has_license(self, repo, license, expected):
        """
        Test that the has_license function correctly
        identifies the presence of a license in a repo
        """
